...
class ChoosePlatformPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final supportsGlass =
        !isAndroidDevice && AppVisualStyle.supportsLiquidGlass;
    ...
    return PlatformScaffold(
      ...
      appBar: PlatformAppBar(title: Text(strings.appearanceOptimizedPlatform)),
          ...
          SettingsSection(
            tiles: [
              styleTile(
                ...
                isAndroidDevice
                    ? strings.systemStyleAndroidDescription
