...
class UserProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return UserProfileStatefulWidget(
      discuz,
      user,
      uid,
...
class UserProfileState extends State<UserProfileStatefulWidget> {
  ...
  Future<void> _editAvatar() async {
    ...
    final current = account.user;
    if (current == null ||
        current.uid != uid ||
        account.discuz?.baseURL != discuz.baseURL)
      return;
    final changed = await Navigator.push<bool>(
      context,
      platformPageRoute(
        context: context,
        builder: (_) => UploadAvatarPage(discuz: discuz, user: current),
      ),
    );
    if (changed != true) return;
    for (final url in {
      current.avatarUrl,
      URLUtils.getAvatarURL(discuz, '$uid'),
      URLUtils.getLargeAvatarURL(discuz, '$uid'),
      URLUtils.getSmallAvatarURL(discuz, '$uid'),
    }) {
      if (url.isNotEmpty) {
        try {
          await CachedNetworkImage.evictFromCache(url);
        } catch (_) {
          // Cache cleanup must not hide a successful server-side upload.
        }
      }
    }
    if (!mounted ||
        ...
        account.discuz?.baseURL != discuz.baseURL)
      return;
    setState(() => avatarRevision = DateTime.now().millisecondsSinceEpoch);
    account.setUser(current);
    _loadUserProfile();
  }
  ...
  void _loadUserProfile() async {
    ...
    final MobileApiClient client = MobileApiClient(
      dio,
      baseUrl: discuz.baseURL,
    );

    client
        .userProfileResult(uid)
        .then((value) {
          if (!mounted) return;
          setState(() {
            isUpdating = false;
  ...
  Widget build(BuildContext context) {
    ...
    if (_userProfileResult == null) {
      ...
      return PlatformScaffold(
        ...
        body: ErrorCard(
          DiscuzError(
            _userProfileResult!.errorResult!.key,
              ...
              delegate: SliverChildListDelegate([
                              ...
                              children: [
                                ...
                                if (account.user?.uid == uid &&
                                  ...
                                  PlatformTextButton(
                                    ...
                                    child: Text(S.of(context).friendList),
                                  ),
                                if (account.user?.uid == uid &&
                                    account.discuz?.baseURL == discuz.baseURL)
                                  PlatformTextButton(
                                ...
                                PlatformLiquidGlassAvatar(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        '${URLUtils.getLargeAvatarURL(discuz, uid.toString())}${avatarRevision == 0 ? '' : '&v=$avatarRevision'}',
                                    fit: BoxFit.cover,
                ...
                Container(
                  ...
                  child: PlatformCard(
                    ...
                    child: Container(
                      padding: EdgeInsets.all(4.0),
                      child: Column(children: getCreditList()),
                    ),
                  ),
                ),
                // medal list
                    ...
                    child: PlatformCard(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            for (var medal
                                in _userProfileResult!.variables
                                    .getSpace()
                                    .medalList)
                              UserProfileListItem(
  ...
  List<UserProfileListItem> getCreditList() {
    ...
    extendCreditList.add(
      UserProfileListItem(
        icon: Icon(PlatformIcons(context).credits, color: Colors.white),
    ...
    if (extendCreditMap.containsKey("1")) {
      extendCreditList.add(
        UserProfileListItem(
          icon: Icon(PlatformIcons(context).work, color: Colors.white),
          title: extendCreditMap["1"]!.title,
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits1.toString() +
    ...
    if (extendCreditMap.containsKey("2")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits2.toString() +
    ...
    if (extendCreditMap.containsKey("3")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits3.toString() +
    ...
    if (extendCreditMap.containsKey("4")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits4.toString() +
    ...
    if (extendCreditMap.containsKey("5")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits5.toString() +
    ...
    if (extendCreditMap.containsKey("6")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits6.toString() +
    ...
    if (extendCreditMap.containsKey("7")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits7.toString() +
    ...
    if (extendCreditMap.containsKey("8")) {
      extendCreditList.add(
        UserProfileListItem(
          ...
          titleColor: Colors.white,
          describe:
              spaceVariables.extcredits8.toString() +
