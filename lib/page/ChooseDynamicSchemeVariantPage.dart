...
class ChooseDynamicSchemeVariantPage extends StatefulWidget {
  @override
  _ChooseDynamicSchemeVariantState createState() =>
      _ChooseDynamicSchemeVariantState();
}

class _ChooseDynamicSchemeVariantState
    extends State<ChooseDynamicSchemeVariantPage> {
  DynamicSchemeVariant _selectedDynamicSchemeVariant =
        ...
        sections: [
          SettingsSection(tiles: [
            SettingsTile(
              ...
              trailing: (_selectedDynamicSchemeVariant ==
          ...
          SettingsSection(tiles: [
            if (isMaterial(context)) CustomSettingsTile(child: Divider()),
            SettingsTile(
              leading: Icon(
                  AppPlatformIcons(context).dynamicSchemeDescriptionOutlined),
              title: Consumer<ThemeNotifierProvider>(
                builder: (BuildContext context, ThemeNotifierProvider value,
                    Widget? child) {
                  return Text(
                      value.getDynamicSchemeVariantDescription(context));
                },
              ),
            ),
            if (_selectedDynamicSchemeVariant != DynamicSchemeVariant.fidelity)
              SettingsTile(
                ...
                title: Text(S.of(context).dynamicSchemeVariantNotification,
                    style: TextStyle(
            ...
            if (_selectedDynamicSchemeVariant == DynamicSchemeVariant.fidelity)
              SettingsTile(
                ...
                title: Text(
                    S.of(context).dynamicSchemeVariantFidelityNotification,
  ...
  void changeDynamicVariant(DynamicSchemeVariant dynamicSchemeVariant) {
    ...
    UserPreferencesUtils.putInterfaceDynamicSchemeVariantPreference(
        dynamicSchemeVariant);
