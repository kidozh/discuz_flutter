...
class AppleIntelligenceConfState extends State<AppleIntelligenceConfPage> {
      ...
      builder: (dialogContext) => PlatformAlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              PlatformListTile(
                title: Text(S.of(context).appleIntelligenceGuardrailLevelPermissive),
              ...
              PlatformListTile(
                title: Text(S.of(context).appleIntelligenceGuardrailLevelStandard),
                leading: Radio<GuardrailLevel>.adaptive(
              ...
              PlatformListTile(
                title: Text(S.of(context).appleIntelligenceGuardrailLevelStrict),
                leading: Radio<GuardrailLevel>.adaptive(
            ...
            if (aiAvailable)
              PlatformIconButton(
                ...
                onPressed: () async {
                  ...
                  final rule = await Navigator.push<String>(
                      context,
                      platformPageRoute(
                          context: context,
                          builder: (context) => AddAiModelRulePage()));
          ...
          sections: [
            ...
            if (appleAiEnabled)
              SettingsSection(tiles: [
                SettingsTile.navigation(title: Text(S.of(context).appleIntelligenceTranslate))
              ]),
  ...
  void _checkAiAvailability() async {
    if (Platform.isIOS|| Platform.isMacOS){
      ...
      try{
        AvailabilityResponse availabilityResponse = await foundationModels.checkAvailability();
        print(
        ...
        setState(() {
          ...
          errorCode =
          availabilityResponse.reasonCode == null ? "" : availabilityResponse.reasonCode!;
      ...
      setState((){
        aiAvailable = false;
        errorCode = "-1";
        errorMessage = S.of(context).appleIntelligenceNotSupportedInThisPlatform;
      });
    }
  ...
  Widget get appleIntelligenceNotSupportedWidget => Container(
    ...
    child: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 16,),
            Icon(Icons.security_update_warning, size: 32, color: Theme.of(context).colorScheme.primary,),
            SizedBox(height: 24,),
            Text(S.of(context).appleIntelligenceNotSupported, style: TextStyle(
                color: Theme.of(context).colorScheme.onPrimaryContainer,
                fontSize: 24
            ),),
            SizedBox(height: 12,),
            Text("${errorMessage} (${errorCode})", style: TextStyle(
              color: Theme.of(context).colorScheme.onPrimaryContainer.withAlpha(120),
                fontSize: 16
            )),
            SizedBox(height: 24,),
            SizedBox(
              ...
              child: PlatformElevatedButton(
                color: Theme.of(context).colorScheme.primary,
                child: Text(S.of(context).appleIntelligenceHelp, style: TextStyle(
