...
class NewThreadWidget extends StatelessWidget{
  ...
  NewThreadWidget(this._discuz,this._user,this._newThread, this.onSelectTid, {this.afterTid});

  @override
  Widget build(BuildContext context) {
    return ForumThreadWidget(_discuz, _user, _newThread.toForumThread(), null, onSelectTid, afterTid: afterTid,);
  }
