...
class HotThreadWidget extends StatelessWidget{
  ...
  HotThreadWidget(this._discuz,this._user,this._hotThread, this.onSelectTid, {this.afterTid});

  @override
  Widget build(BuildContext context) {

    return ForumThreadWidget(_discuz, _user, _hotThread.toForumThread(), null, onSelectTid, afterTid: afterTid,);
  }
...
//   bool? afterTid = false;
//
//   HotThreadStatefulWidget(this._discuz,this._user,this._hotThread, {this.afterTid});
//
//   @override
//   HotThreadState createState() {
//     return HotThreadState(this._discuz,this._user,this._hotThread, afterTid:afterTid);
//   }
//
// }
//
...
//   bool? afterTid = false;
//
//   HotThreadState(this._discuz,this._user,this._hotThread, {this.afterTid});
//
//   @override
//   void initState() {
//     loadDatabase();
