...
class SteamGameState extends State<SteamGameWidget> {
  ...
  String appId = "";
  SteamApiClient get client =>
      SteamApiClient(NetworkUtils.getDio(), baseUrl: steamStoreBaseUrl(url));
  ...
  Future<void> loadGameState() async {
    ...
    try {
      final languageCode = LanguageCode.code.englishName
          ...
          .toLowerCase();
      final text = await (widget.client ?? client).getSteamGameResultByAppId(
        requestedAppId,
        languageCode,
      );
            ...
            Padding(
              ...
              child: Text(
                HtmlUnescape().convert(
                  steamGameDataResult.data.short_description,
                ),
                maxLines: 3,
                style: TextStyle(
                  height: 1.2,
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    for (final category in steamGameDataResult.data.categories)
                ...
                Align(
                  ...
                  child: PlatformTextButton(
                    onPressed: () => URLUtils.openURL(
                      context,
                      null,
                      '${steamStoreBaseUrl(url)}app/${steamGameDataResult.data.parentAppId}/',
                      null,
                      null,
                    ),
                    child: Text(
              ...
              if (!steamGameDataResult.data.isSoundtrack &&
                ...
                Row(
                  children: [
                    Icon(PlatformIcons(context).translate, size: 16),
                    SizedBox(width: 16.0),
                    Expanded(
                      child: Column(
              ...
              SizedBox(
                ...
                child: PlatformElevatedButton(
                  onPressed: () {
                    ...
                    String steamUrl = "${steamStoreBaseUrl(url)}app/${appId}";
                    VibrationUtils.vibrateWithClickIfPossible();
  ...
  String _contentTypeLabel(BuildContext context) {
    ...
    return switch (steamGameDataResult.data.type.toLowerCase()) {
      ...
      'tool' ||
      'application' ||
      'software' => labels.steamTypeSoftware,
  ...
  Widget get supportedPlatformRow => Row(
    ...
    children: [
      ...
      if (steamGameDataResult.data.platforms.linux)
        Container(
          margin: EdgeInsets.only(top: 8.0, left: 6.0),
          child: FaIcon(FontAwesomeIcons.linux, size: 14),
        ),
    ],
  );
