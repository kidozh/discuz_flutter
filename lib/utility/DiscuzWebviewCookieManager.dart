...
class DiscuzWebviewCookieManager {
  ...
  factory DiscuzWebviewCookieManager() {
    return _instance ??= DiscuzWebviewCookieManager._();
  }

  DiscuzWebviewCookieManager._();

  static DiscuzWebviewCookieManager? _instance;
  ...
  String removeInvalidCharacter(String value) {
    ...
    // remove baidu analytic cookie problem!!!!!!
    valueModified = valueModified.replaceAll(String.fromCharCode(44), "");
