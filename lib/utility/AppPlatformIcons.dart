...
class AppPlatformIcons{
  ...
  IconData get postThreadSolid => isMaterial(context)? Icons.send : CupertinoIcons.arrow_up_circle;
  ...
  IconData get pictureBedOutlined => isMaterial(context)? Icons.photo_album_outlined : CupertinoIcons.archivebox;
