...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m10(name) => "自定义 · ${name}";

  static String m11(day) => "${day}天前";

  static String m12(day) => "${day}天后";

  static String m13(account) => "成功移除账号 ${account}。";

  static String m14(account) => "成功删除论坛 ${account}。";

  static String m15(sitename) => "我们默认移除${sitename}的应用广告";
  ...
  static String m18(filename) => "后台下载文件 ${filename} 中。";

  static String m19(discuz, discuzUrl) =>
      "我建议添加 ${discuz}（${discuzUrl}）到订阅频道获得定时的推送。";

  static String m20(discuz) => "收录${discuz}到订阅频道中";

  static String m21(discuz) => "通知我们收录${discuz}";

  static String m22(size) => "${size}逻辑像素";

  static String m23(size) => "${size}倍";

  static String m24(device, version) =>
      "--- 消息由 ${device} 的 [url=https://discuzhub.kidozh.com/]谈坛（v${version}）[/url]发出。";

  static String m25(device) => "消息由${device}发出。";

  static String m26(language) => "不支持${language}";

  static String m27(readAccess, star) => "阅读权限： ${readAccess}， 等级： ${star}";

  static String m28(hour) => "${hour}小时前";

  static String m29(hour) => "${hour}小时后";

  static String m30(uri) => "无法打开此链接 : ${uri}.";

  static String m31(name) => "${name}的Linux电脑";

  static String m32(name) => "${name}的MacOS设备";

  static String m33(min) => "${min}分钟前";

  static String m34(min) => "${min}分钟后";

  static String m35(discuz) => "${discuz}目前还没有任何订阅消息";

  static String m36(hour) => "${hour}小时";

  static String m37(pictureBedName) => "此服务由${pictureBedName}提供";

  static String m38(time) => "该投票于${time}过期.";

  static String m39(people) => "共有${people}人已投票.";

  static String m40(pos) => "第${pos}层";

  static String m41(discuz) => "${discuz}并未启用推送服务";
  ...
  static String m43(name) => "举报${name}的内容";

  static String m44(discuzName) => "成功向${discuzName}发送了举报信息，请等待管理员回应。";

  static String m45(username, discuzName) =>
      "用户 ${username} 已成功登录到 ${discuzName}。";

  static String m46(discuzName) => "登录至 ${discuzName}";

  static String m47(index) => "表情 ${index}";

  static String m48(checked, allowed) => "投票 (${checked} / ${allowed})";

  static String m49(title) => "成功删除历史记录 ${title}.";

  static String m50(filename) => "成功下载文件： ${filename}。";

  static String m51(num) => "已同步所有${num}个收藏的帖子";

  static String m52(num) => "阅读权限 ${num}";

  static String m53(reply) => "${reply}回复";

  static String m54(view) => "${view}浏览";

  static String m55(username) => "用户 ${username} 已失效";

  static String m56(uid) => "用户编号： ${uid}";

  static String m57(user) => "查看${user}详情";

  static String m58(name) => "${name}的Windows电脑";
