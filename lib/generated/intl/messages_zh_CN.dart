...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(device) => "消息由${device}发出。";

  static String m18(readAccess, star) => "阅读权限： ${readAccess}， 等级： ${star}";

  static String m19(hour) => "${hour}小时前";

  static String m20(hour) => "${hour}小时后";

  static String m21(uri) => "无法打开此链接 : ${uri}.";

  static String m22(name) => "${name}的Linux电脑";

  static String m23(name) => "${name}的MacOS设备";

  static String m24(min) => "${min}分钟前";

  static String m25(min) => "${min}分钟后";

  static String m26(discuz) => "${discuz}目前还没有任何订阅消息";

  static String m27(hour) => "${hour}小时";

  static String m28(pictureBedName) => "此服务由${pictureBedName}提供";

  static String m29(time) => "该投票于${time}过期.";

  static String m30(people) => "共有${people}人已投票.";

  static String m31(pos) => "第${pos}层";

  static String m32(discuz) => "${discuz}并未启用推送服务";
  ...
  static String m34(name) => "举报${name}的内容";

  static String m35(discuzName) => "成功向${discuzName}发送了举报信息，请等待管理员回应。";

  static String m36(username, discuzName) =>
      "用户 ${username} 已成功登录到 ${discuzName}。";

  static String m37(discuzName) => "登录至 ${discuzName}";

  static String m38(index) => "表情 ${index}";

  static String m39(checked, allowed) => "投票 (${checked} / ${allowed})";

  static String m40(title) => "成功删除历史记录 ${title}.";

  static String m41(filename) => "成功下载文件： ${filename}。";

  static String m42(num) => "已同步所有${num}个收藏的帖子";
